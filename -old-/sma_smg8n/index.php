...
define('APP_SUBDOMAIN', 'sma_smg8n');
...
define('TITLE_LOGIN', 'SMAN 8 SEMARANG');
define('APP_TITLE', 'SMAN 8');
define('APP_PLACE', 'SMAN 8');
define('APP_SCHOOL', 'SMA Negeri 8 Semarang');

define('APP_SCHOOL_ADDRESS', 'Jl. Raya Tugu Semarang');
