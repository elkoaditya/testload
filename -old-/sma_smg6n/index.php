...
define('APP_SUBDOMAIN', 'sma_smg6n');
...
define('TITLE_LOGIN', 'SMAN 6 SEMARANG');
define('APP_TITLE', 'SMAN 6');
define('APP_PLACE', 'SMAN 6');
define('APP_SCHOOL', 'SMA Negeri 6 Semarang');

define('APP_SCHOOL_ADDRESS', '');
