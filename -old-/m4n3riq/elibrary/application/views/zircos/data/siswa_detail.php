...
<?php 
	if(( $this->session->userdata['user']['role'] == 'user' )&&( $this->session->userdata['user']['id'] != $data['data_siswa']['data'][1]['siswa_id'] )){
		redirect(base_url()."data/siswa/detail/".$this->session->userdata['user']['id']);
	}
	...
	$detail = array(
			...
			//'siswa_alamat'				=> 'Alamat',
			'siswa_perpus_buku_favorit' => 'Buku Favorit',
				...
				<div class="page-title-box">
					<div class="btn-group pull-right">
						<ol class="breadcrumb hide-phone p-0 m-0">
							<li >
								 <a href="<?=base_url();?>/data/siswa">Siswa Membaca</a>
							</li>
							<li class="active">
								Detail Siswa Membaca
							</li>
						</ol>
					</div>
					<h4 class="page-title"> Detail Siswa Membaca</h4>
				</div>
			</div>
		</div>
				...
				<div class="col-sm-4">
					...
					<div class="row">
						<div class="col-sm-1"></div>
							...
							<div class="card-box ">
									<?php 
									$image = base_url().'content/images/siswa/user_default.png';
									if($key['siswa_perpus_foto'] != ""){ 
										$image = base_url().'content/upload/avatar/'.$key['siswa_perpus_foto'];
									}
									?>
					...
					<div class="card-box table-responsive">
						<table id="datatable-buttons1" class="table table-striped table-bordered">
							...
							<tbody>
								...
								if(isset($data['data_siswa_baca']['data'])){
									foreach($data['data_siswa_baca']['data'] as $value_di=>$key){
										//////////////// buku /////////
										$no++;?>
								<tr>
									<td> <?=$no?> </td>
