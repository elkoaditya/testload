...
<div class="wrapper">
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="page-title-box">
					...
					<h4 class="page-title"> Form Tag Buku</h4>
				</div>
			</div>
		</div>
        ...
        <div class="row">
			<div class="col-sm-12">
				<div class="card-box">
					<h4 class="m-t-0 header-title"><b>Form Tag Buku</b></h4>
					
					<div class="row">
						<div class="col-md-8">                           
							<form action="<?=base_url();?>data/tag/save" class="form-horizontal form-row-seperated" method="POST">
