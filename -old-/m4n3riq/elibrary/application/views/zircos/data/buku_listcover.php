			...
			<div class="col-md-12">
				<div class="card-box">
					<div class="row">
						...
						<form class="form-inline" action="<?=base_url();?>data/buku/listcover" method="GET" >
						...
						<!--
						<form action="<?=base_url();?>data/buku/listcover" method="GET" >
				...
				<div class="text-right">
					<ul class="pagination pagination-split">
						...
						if($data['offset']==0){
							...
							?>
						<li <?=$page_first?>>
							<a href="<?=base_url("data/buku/listcover".$req_uri)?>"> < </a>
						</li>
						...
						while($max_data>0){
							...
							?>
							<li <?=$page_active?>>
								<a href="<?=base_url("data/buku/listcover/".$data['limit']."/".$offset.$req_uri)?>"><?=$no?></a>
							</li>
							<?php
						...
						if($data['offset']==$offset){
							...
							?>
						<li <?=$page_last?>>
							<a href="<?=base_url("data/buku/listcover/".$data['limit']."/".$offset.$req_uri)?>"> > </a>
						</li>
					</ul>
				</div>
			</div>
