...
//// CORE
	...
	{	
		define('SEKOLAH', 'SMP TERBANG');
		define('LOGO_SEKOLAH', 'smp_terbang.jpg');	
		define('APP_SCOPE', 'smp_terbang');
	}
	
	elseif(APP_SUBDOMAIN =='smk_pika')
	{	
		define('SEKOLAH', 'SMK PIKA');
		define('LOGO_SEKOLAH', 'smk_pika.png');	
		define('APP_SCOPE', 'smk_pika');
	}
