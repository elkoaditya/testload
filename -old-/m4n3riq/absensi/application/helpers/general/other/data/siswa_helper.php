...
if (!function_exists('view_loader')) {
	...
	function print_siswa1($data = '', $output ) {
		$data['page_view'] = 'data/siswa_print';
        return viewhelper_siswa1($data, 3, $output);
    }
	 function viewhelper_siswa1($data = '',$plugin, $output=true) {
        $CI = &get_instance();
		$d =  $CI->d;
		$d['data'] =  $data;
		// $d['print_page'] =  "L";
