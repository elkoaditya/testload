    ...
    <div class="card">
        <div class="card-content">
                    ...
                    <tbody>
                        @foreach ($daftar_kelas as $kelas)
                            <tr>
                                ...
                                <td>
                                    <small><a class="wwaves-effect waves-light btn modal-trigger mb-2 mr-1n" href="#modal1" data-id_kelas="{{$kelas->id_kelas}}" id="data_kelas"><i class="material-icons left">file_download</i> By Mount</a></small>
                                </td>
                            </tr>
                        @endforeach
            ...
            <div id="modal1" class="modal modal-fixed-footer">
                <form action="{{"https://".$_SERVER['HTTP_HOST'].'/'.APP_SUBDOMAIN}}/agenda/bulan" method="post">
                    @csrf
            ...
            <div id="modal2" class="modal modal-fixed-footer">
                <form action="/export/tanggal" method="post">
                    @csrf
                    <div class="modal-content">
                        <div class="row">
                            <div class="col s12">
                                <div id="date-picker" class="card card-tabs">
                                    <div class="card-content">
                                        ...
                                        <div id="view-date-picker">
                                            <p>Pilih tanggal yang ingin di download <br>( Apabila di tanggal yang di download tidak ada record absen maka data yang di download tidak dapat di tampilkan )</p>
