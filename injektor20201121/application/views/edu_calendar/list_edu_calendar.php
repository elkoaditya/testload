...
<div id="page-wrapper">
	...
	?>
            ...
            <tr>
				...
				<?php
				if($c->file!=''){
					echo '<td align="left"><img width="140px" src="'.$url.'content/'.APP_SCOPE.'/kaldik/'.$c->file.'"></td>';
				}else{
...
function hapus(id,nama){
	$.prompt("Menghapus Kalender Akademik <font color='#FF0000'>"+nama+"</font>", {
		title: "Peringatan",
