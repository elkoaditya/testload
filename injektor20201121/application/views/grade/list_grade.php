...
<div id="page-wrapper">
	...
	?>
            <tr>
                ...
                <td align="right"><?=$c->grade;?></td>
                <td><a href="<?php echo site_url("/".$title_eng."/detail/id/".$c->nilai_kelas_id);?>"><?=$c->nama;?></a></td>
                <td align="left"><?=$c->nama_wali;?></td>
                <td align="center"><?=$c->nama_kurikulum;?></td>
                
                <td align="center">
                <a href="<?php echo site_url("/".$title_eng."/form/update/".$c->nilai_kelas_id."/".$c->id);?>" class="btn btn-warning btn-xs">
				<img src="<?php echo base_url("public/img/pencil.png");?>" /> Edit</a></td>
                <!--<td align="center">
                <a href="javascript:void(0)" onclick="hapus('<?=$c->nilai_kelas_id;?>','<?=$c->id;?>','<?=$c->nama;?>')"><img src="<?php echo base_url("public/img/cross.png");?>" /></a></td>
            	-->
            </tr>
	<?php
