...
function listenMessage(msg) {
	//alert(msg.data);
	window.tinymce.EditorManager.activeEditor.insertContent('<img src="' + msg.data +'">');
	window.tinymce.EditorManager.activeEditor.windowManager.close(window);
	//window.tinymce = tinyMCE = null;
}
