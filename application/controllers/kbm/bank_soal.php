...
class Bank_soal extends MY_Controller
{
	...
	public function __construct()
	{
		parent::__construct(array(
			...
			'kbm/bank_soal/laporan_guru_input' => array(
						'user'		 => array('admin', 'sdm'),
						'helper'	 => 'excel',
				),
...
*/
	...
	public function laporan_guru_input() {
		$d = & $this->d;
		$this->_set('kbm/bank_soal/laporan_guru_input');
		$this->m_kbm_bank_soal->laporan_guru_input();
