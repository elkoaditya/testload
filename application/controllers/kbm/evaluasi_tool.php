...
class Evaluasi_tool extends MY_Controller {
	...
	public function pakta_integritas(){
		...
		$gambar_pakta_integritas 		= $this->m_app_config->get('gambar_pakta_integritas');
		...
		$d['gambar_pakta_integritas'] 		= $gambar_pakta_integritas;
	...
	{
		$response = $this->m_kbm_evaluasi_tool->input_absensi();
