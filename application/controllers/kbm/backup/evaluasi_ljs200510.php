...
class Evaluasi_ljs extends MY_Controller {
	...
	public function __construct() {
		parent::__construct(array(
				...
				'kbm/evaluasi_ljs/surveillance_all' => array(
						'user' => array('sdm', 'admin'),
						'library' => 'pagination',
						'model' => 'm_option',
						'helper' => 'form',
	...
	public function surveillance($index = 0) {
		...
		$this->d['resultset'] = $this->m_kbm_evaluasi_ljs->surveillance($index, 50);
		
		$this->_view();
	}
	public function surveillance_all($index = 0) {
		$this->_set('kbm/evaluasi_ljs/surveillance_all');
		$this->_rowset_evaluasi();
