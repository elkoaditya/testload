...
class Postacceptor extends MY_Controller {
	...
	public function index($lang = 'english') {
		...
		// echo json_encode($config);
			...
			if ($this->upload->do_upload('file')) { // Success
				// General result data
				...
				echo json_encode(array('location' => $result['file_name']));
				...
				// Output to user
				//$this->load->view('ajax_upload_result', $result);
				echo json_encode(array('error' => $result['result'],'a' => $_FILES['file']['name']));
