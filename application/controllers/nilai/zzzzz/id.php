...
function link_action($row)
{
	...
	return a($url_nilsispel, 'editi', 'class="btn btn-warning"');
...
$pills_fbar['impor'] = array(
	...
	'uri'	 => "nilai/pelajaran/impor/{$row['id']}",
	'attr'	 => 'title="impor daftar nilai pelajaran"',
	'class'	 => 'disabled',
);
$pills_fbar['expor'] = array(
	'label'	 => '<i class="icon-download"></i> Expor',
	'uri'	 => "nilai/pelajaran/expor/{$row['id']}" . array2qs(),
	'attr'	 => 'title="expor daftar nilai pelajaran" target="_blank"',
	'class'	 => 'active',
);
...
$table_nilsis_akhir = array(
	...
	'data'				 => array(
		...
		div_right('<b>MID Predikat Sikap</b>')	 => array('mid_pred_sikap', 'display_nilai'),
		div_right('<b>Akhir Teori</b>')			 => array('nas_teori', 'display_nilai'),
		div_right('<b>Akhir Praktek</b>')		 => array('nas_praktek', 'display_nilai'),
		...
		div_right('<b>Akhir Predikat Sikap</b>') => array('pred_sikap', 'display_nilai'),
		'&nbsp;'								 => '&nbsp;',
...
for ($i = 1; $i <= 12; $i++):
	$kolom = div_right($i);
	$table_nilsis_ulangan['data'][$kolom] = array('u' . $i, 'display_nilai');
	$table_nilsis_remidi['data'][$kolom] = array('r' . $i, 'display_nilai');
	$table_nilsis_harian['data'][$kolom] = array('h' . $i, 'display_nilai');
	$table_nilsis_tugas['data'][$kolom] = array('t' . $i, 'display_nilai');
	$table_nilsis_praktek['data'][$kolom] = array('p' . $i, 'display_nilai');
	$table_nilsis_sikap['data'][$kolom] = array('s' . $i, 'display_nilai');
endfor;
	...
	<body class="preview" id="top" data-spy="scroll" data-target=".subnav" data-offset="80">
		...
		<div class="container">
			...
			<div id="tabel">
				...
				for ($i = 1; $i <= 6; $i++)
					echo "<th colspan='2'><div align='center'><b>KD {$i}</b></div></th>" . NL;
