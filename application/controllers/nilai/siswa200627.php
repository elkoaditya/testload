...
*/
	...
	public function rapor_tik_generator($id = 0, $mode_range = 100, $tipe_rapor = 'original')
	{
...
//echo"b";
	...
	//echo"c";		
			...
			$mpdf->setAutoBottomMargin = TRUE;
			$mpdf->WriteHTML($body);
			$mpdf->Output(APP_ROOT."content/generate_rapor_tik/".APP_SCOPE
			."/".$d['row']['siswa_nis'].".pdf", 'F');
			unset($mpdf);
			unset($body);
			// }
	...
	public function rapor_tik($id = 0, $mode_range = 100, $tipe_rapor = '', $dump = '')
	{
		...
		if(APP_SCOPE=='sma_terbang'){
			...
			$abre_filename = APP_SCOPE;
			$nama_file	= "rapor_tik-nis-{$d['row']['siswa_nis']}-{$d['row']['ta_nama']}-{$d['row']['semester_nama']}";
