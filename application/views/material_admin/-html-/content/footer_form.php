...
-->    
		...
		<script src="<?php echo base_url("assets/material_admin"); ?>/vendors/bower_components/moment/min/moment.min.js"></script>
        <script src="<?php echo base_url("assets/material_admin"); ?>/vendors/bower_components/bootstrap-select/dist/js/bootstrap-select.js"></script>
        <script src="<?php echo base_url("assets/material_admin"); ?>/vendors/bower_components/nouislider/distribute/nouislider.min.js"></script>
        <script src="<?php echo base_url("assets/material_admin"); ?>/vendors/bower_components/eonasdan-bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js"></script>
        <script src="<?php echo base_url("assets/material_admin"); ?>/vendors/bower_components/typeahead.js/dist/typeahead.bundle.min.js"></script>
        <script src="<?php echo base_url("assets/material_admin"); ?>/vendors/bower_components/dropzone/dist/min/dropzone.min.js"></script>
        <script src="<?php echo base_url("assets/material_admin"); ?>/vendors/summernote/dist/summernote-updated.min.js"></script>

        <!-- Placeholder for IE9 -->
        <!--[if IE 9 ]>
            <script src="<?php echo base_url("assets/material_admin"); ?>/vendors/bower_components/jquery-placeholder/jquery.placeholder.min.js"></script>
        <![endif]-->
		
        <script src="<?php echo base_url("assets/material_admin"); ?>/vendors/bower_components/chosen/chosen.jquery.js"></script>
        <script src="<?php echo base_url("assets/material_admin"); ?>/vendors/bower_components/jquery-mask-plugin/dist/jquery.mask.min.js"></script>
        <script src="<?php echo base_url("assets/material_admin"); ?>/vendors/fileinput/fileinput.min.js"></script>
        <script src="<?php echo base_url("assets/material_admin"); ?>/vendors/farbtastic/farbtastic.min.js"></script>
