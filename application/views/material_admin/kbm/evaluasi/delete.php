...
if (!$error)
	alert_info(div('align="center"', '<h3>Apakah Anda yakin akan menghapus evaluasi ini??</h3>'));
...
<html>
<?php $this->load->view(THEME . "/-html-/head", array('title' => 'Hapus Evaluasi')); ?>
	...
	<section id="content">
        ...
        <div class="container">
            ...
            <div class="block-header">
                <h2 id="title_page"><b>Hapus Evaluasi</b></h2>
            </div>
