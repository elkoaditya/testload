...
if (!$error)
	alert_info(div('align="center"', '<h3>Apakah Anda yakin akan menutup evaluasi ini??</h3>'));
...
<html>
<?php $this->load->view(THEME . "/-html-/head", array('title' => 'Tutup Evaluasi')); ?>
	...
	<section id="content">
        ...
        <div class="container">
            ...
            <div class="block-header">
                <h2 id="title_page"><b>Tutup Evaluasi</b></h2>
            </div>
...
// form button
				...
				echo '<div>'
				. $btn_back . ' &nbsp; &nbsp; '
				. '<button type="submit" class="btn bgm-deeporange btn-sm m-b-5 m-r-5" id="tutup"><i class="zmdi zmdi-alert-circle"></i> TUTUP !</button> '
				. '</div>';
				echo '</fieldset>';
...
setTimeout(function(){delayAnimation('tutup','rubberBand')},5900);
