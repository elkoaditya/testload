	...
	<section id="content">
        ...
        <div class="container">
			...
			<div class="card" id="table">
							...
							<div class="col-sm-6 col-md-12" id="admin">
								<a href="<?php echo base_url("data/profil/admin"); ?>" >
									<div class="mini-charts-item bgm-lightgreen">
										<div class="clearfix">
											<div class="chart ">
												<img src="<?php echo base_url("images/logo_material_admin");?>/admin.png" width="65" alt="">
											</div>
											<div class="count">
												<small>daftar</small>
												<h2>ADMIN</h2>
...
<?php
	$array_animated = array('evaluasi', 'materi', 'siswa', 'sdm' , 'admin');
?>
