...
$breadcrumbs = array(
	...
	'Config',
	'Gambar dari Keterangan Pakta Integritas'
);
...
$input = array(
	'config_value',
	//'html_entity_decode',
	'label'		 => 'Gambar dari Keterangan Pakta Integritas',
	'type'			 => 'textarea',
	'name'			 => 'config_value',
	'id'			 => 'config_value',
	'class'			 => 'input input-xxlarge tinymce_mini',
	'placeholder'	 => 'gambar dari Keterangan Pakta Integritas',
	'value'		 => $config_value,
		...
		<div class="container">
			...
			<div id="tabel">
				<div class="page-header">
					<h1>Konfigurasi Gambar dari Keterangan Pakta Integritas</h1>
				</div>
