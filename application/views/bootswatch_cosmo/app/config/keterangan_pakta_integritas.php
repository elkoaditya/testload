...
$input = array(
	'config_value',
	//'html_entity_decode',
	'label'		 => 'Keterangan Pakta Integritas',
	'type'			 => 'textarea',
	'name'			 => 'config_value',
	'id'			 => 'config_value',
	'class'			 => 'input input-xxlarge ',
	'placeholder'	 => 'isi di Keterangan Pakta Integritas',
	'value'		 => $config_value,
		...
		<div class="container">
			...
			<div id="tabel">
				<div class="page-header">
					<h1>Konfigurasi Keterangan Pakta Integritas</h1>
				</div>
