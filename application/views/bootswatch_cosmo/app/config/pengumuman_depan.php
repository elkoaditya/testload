...
$input = array(
	'config_value',
	//'html_entity_decode',
	'label'		 => 'Pengumuman Depan Halaman Login',
	'type'			 => 'textarea',
	'name'			 => 'config_value',
	'id'			 => 'config_value',
	'class'			 => 'input input-xxlarge tinymce_mini',
	'placeholder'	 => 'isi pengumuman di depan (HALAMAN LOGIN)',
	'value'		 => $config_value,
		...
		<div class="container">
			...
			<div id="tabel">
				<div class="page-header">
					<h1>Konfigurasi Pengumuman Depan Halaman Login</h1>
				</div>
