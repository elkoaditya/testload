...
if ($user['role'] == 'siswa'):
	...
	$pills_kanan = array(
		...
		'simulasi'	 => array(
			...
			'uri'	 => "kbm/evaluasi_ljs/".$set_form."?id={$row['id']}",
...
{
	return a("/kbm/evaluasi_ljs/surveillance?evaluasi_id=".$_COOKIE['evaluasi_id']."&kelas_id=".$row['kelas_id'], 'SURVEILLANCE', 'class="btn btn-success" title="memata-matai pengerjaan"');
}
