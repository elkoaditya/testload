	...
	<div id="tabel">
		...
		<div class='t-border2'>
			...
			*/
			...
			echo "<td class='info' >: ".$evaluasi['kelas_result']['data'][$request['kelas_id']]['evaluasi_durasi']."</td> ";
			echo"
				</tr>
			</table>
		...
		foreach ($resultset['data'] as $idx => $butir):
			...
			if(strlen($butir['pertanyaan'])<2000){
		...
		if($evaluasi['plus_uraian']==1){
			...
			echo '<br/><span style="font-size:13px;"><b>Jawablah Uraian dibawah ini secara jelas ! </b></span><br/>';
			echo '<br/><table border="0">';
			echo '<tr>';
			echo '<td width="5px"></td>';
			echo '<td valign="top" align="left">';
			echo $evaluasi['detail_uraian'] . '<br/>';
