...
function display_rapor($row)
{
	...
	$html .= "<li class='active'>".a("nilai/siswa/kartu_barcode/{$row['kelas_id']}", "Kartu Siswa", 
				'title="cetak detail kartu siswa" target="_blank"') . "</li>";
	...
	$html .= "<li class='active'>".a("nilai/siswa/rapor_mid_generator/{$row['id']}/100/ttd", "Generate_RaporMid", 
				'title="cetak surat rapor mid di server" target="_blank"') . "</li>";
	...
	$html .= "<li class='active'>".a("nilai/siswa/rapor_kelas/{$row['id']}/100/ttd?download=1", 'RaporAkhir+TTD', 
			'title="cetak rapor semester siswa" target="_blank"') . "</li>";
	...
	if(($row['kelas_grade']==12)||($row['kelas_grade']==9))
	{
	...
	if(APP_SCOPE=='smp_terbang'){
		$html .= "<li class='active'>".a("nilai/kelas/penuntasan/{$row['id']}", 'Penuntasan', 
				'title="penuntasan siswa"') . "</li>";
	}
	...
	$html .= "<li class='active'>".a("nilai/siswa_tool/kartu_ujian/{$row['kelas_id']}", "Kartu Ujian", 
				'title="cetak kartu ujian" target="_blank"') . "</li>";
