...
<div id="content1" style=" padding-top:-20px;">
			...
			<div style=" padding-top:10px;">			
               ...
               <table border="0" cellspacing="0" cellpadding="0" width="100%" style="padding-top:8px; padding-bottom:8px">
			...
			<table border="0" style="width: 100%; padding-top:5px; ">
				<tr>
					...
					<td valign="top">
						...
						KEPALA SEKOLAH <br/>
						<!--<br/><br/><br/>-->
						<img src="<?=APP_ROOT?>/content/sman9smg/ttd/kepsek.PNG" width="250" 
						style="position: absolute; left: 5px; z-index: 1; margin-top:-40px; margin-left:-40px; margin-bottom:-50px; " />
