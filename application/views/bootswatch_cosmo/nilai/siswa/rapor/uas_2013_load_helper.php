...
function tablepdf_2013_v2($resultset,$row,$row_per_siswa,$deskripsi_array,$header,$type_return=0,$page_sikap=0,$background = 0)
{
	$mp_no = 0;
	$ktg_ascii = 64;
	$ktg_nama = NULL;
...
function tablepdf_2013_setiabudhi_v2($resultset,$row,$row_per_siswa,$deskripsi_array,$header,$type_return=0,$page_sikap=0,$background = 0)
{
	$mp_no = 0;
	$ktg_ascii = 64;
	$ktg_nama = NULL;
