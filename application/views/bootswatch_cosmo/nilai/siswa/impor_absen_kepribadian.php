...
<html lang="en">
	...
	<?php $this->load->view(THEME . "/-html-/head", array('title' => 'Impor Absensi, Ahlak Mulia KTSP,<br/>Sikap (Spiritual Sosial) K13 &amp; Ket Kenaikan')); ?>
    ...
    <div class="container">
			...
			<div id="tabel">
				<div class="page-header">
					<h1>Impor Absensi, Ahlak Mulia KTSP,<br/>Sikap (Spiritual Sosial) K13 &amp; Ket Kenaikan</h1>
				</div>
