...
<html lang="en">
	...
	<?php $this->load->view(THEME . "/-html-/head", array('title' => 'Impor Laporan Kegiatan Belajar <br/>di Dunia Usaha/Industri')); ?>
    ...
    <div class="container">
			...
			<div id="tabel">
				<div class="page-header">
					<h1>Impor Laporan Kegiatan Belajar <br/>di Dunia Usaha/Industri</h1>
				</div>
