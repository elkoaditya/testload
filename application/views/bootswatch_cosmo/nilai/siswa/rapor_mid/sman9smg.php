...
/*if($row['kelas_grade']==12){
	...
	$jarak_enter="<br/>";
	$ket_laporan = "LAPORAN PENILAIAN HARIAN TENGAH ";
//}
function int2kata($n) {
...
<div class="page" style=" padding-top:-50px">
	<table border="0" style="width: 100%;">
	  <tr>
		...
		<td width="850" align="center" valign="top"><span class="style13"><span class="style19">PEMERINTAH PROVINSI JAWA TENGAH<br />
		  ...
		  <span class="style16">Jl. Cemara Raya Padangsari Banyumanik Semarang 50267<br/>
		   Telp.(024) 7472812  Fax.(024)7462790<br />
					Website: www.sman9-smg.sch.id  Email : smu092001@yahoo.com</span></td>
	...
	<table border="0" style="width: 100%;">
	  ...
	  <tr>
		...
		<br/>
			<table border="0" style="width: 100%;">
			  <tr>
				<td width="7%" valign="top" class="style17"><b>NAMA</b></td>
				<td width="3px" valign="top" class="style17">:</td>
				<td width="70%" valign="top" class="style17"><b><?php echo strtoupper($row_per_siswa['siswa_nama']); ?></b> </td>
				
				<td width="7%" valign="top" class="style17" align="right"><b>KELAS</b> </td>
				<td width="3px" valign="top" class="style17">:</td>
	...
	<table width="109%" border="1" cellpadding="2" cellspacing="0" style="width:100%;border-collapse: collapse;">
	  <tr>
	   ...
	   baik dalam toleransi, disiplin, santun, jujur, cinta damai, responsif, pro aktif dan 
	...
	<table width="109%" border="1" cellpadding="2" cellspacing="0" style="width:100%;border-collapse: collapse; ">
	  <tr>
		...
		<th width="42%" rowspan="3" class="style20 border_btm1 border_btm2">Komponen</th>
		<th rowspan="3" class="style20 border_btm1 border_btm2">Kriteria Ketuntasan Minimal (KKM)</th>
		<?php if($kurikulum == 'ktsp'){?>
			...
			foreach ($resultset['data'] as $idx => $item): 
				 if ($item['kategori_nama'] != $ktg_nama):
					...
					<?php elseif($item['kategori_kode']=='mulok'):?>
					 ...
					 <tr>
						  <td valign="middle" colspan="7"><div class="style3"><b><?=$item['kategori_nama']?> </b></div></td>
					  </tr>
					 ...
					 <tr>
					  ...
					  <tr>
						  ...
						  <td valign="middle" colspan="6"><div class="style3"><b>Peminatan </b></div></td>
					  </tr>
					  
					  <?php elseif($item['kategori_kode']=='KelD'):?>
					 <tr>
						   <td align="center" valign="middle"><div class="style3"><b>II.</b></div></td>
						  <td valign="middle" colspan="6"><div class="style3"><b>Lintas Minat </b></div></td>
					  </tr>
					<?php
	...
	<table width="100%" border="1" cellspacing="0" cellpadding="2" style="width:100%;border-collapse: collapse;">
	  <tr>
		...
		<td width="42%" align="center"><div align="center" class="style3"><b>Alasan Ketidakhadiran </b></div></td>
		<td align="center"><div align="center" class="style3"><b>Lama </b></div></td>
	  </tr>
	  <tr>
	  ...
	  <tr>
		...
		<td width="47%" align="center" valign="top" >
				...
				<p class="style11 ttdimg"><br/>
					...
					<img src="<?=APP_ROOT?>/images/sman9smg/scan002.jpeg" width="180" style="position: relative; top: 5px; left: 5px; z-index: 999999" />
					<br>-->
		...
		<td width="30%" align="left" valign="top" style="margin-left:30px;">
				...
				Wali Kelas<br/>
					...
					<img src="<?=APP_ROOT?>/content/sman9smg/ttd/<?=$row['wali_id']?>-.PNG" height="70" style="position: absolute; top: 5px; left: 5px; z-index: 1" />
					<br/>
