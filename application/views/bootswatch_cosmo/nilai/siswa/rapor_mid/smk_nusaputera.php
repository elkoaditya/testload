...
//$tanggal_rapor = '8 April 2017';
//$tanggal_rapor = '13 Oktober 2017';
...
?>	
	<table cellspacing="0" border="1" width="50%">
     <tr>
      <td align="center" class="style3">Interval</td>
      <td align="center" class="style3">Predikat</td>
     </tr>
     <tr>
      <td align="center" class="style3">86 ≤ x ≤ 100</td>
      <td align="center" class="style3">A</td>
     </tr>
     <tr>
      <td align="center" class="style3">80 ≤ x ≤ 85</td>
      <td align="center" class="style3">B</td>
     </tr>
     <tr>
      <td align="center" class="style3">75 ≤ x ≤ 79</td>
      <td align="center" class="style3">C</td>
     </tr>
     <tr>
      <td align="center" class="style3">x < 75</td>
      <td align="center" class="style3">D</td>
     </tr>
    </table>   
<?php
}
...
?>	
	...
	<table cellspacing="0" cellpadding="7" border="1" style="width:100%; border-collapse: collapse;" class="kecil">
		...
		<tr>
            ...
            <?php if($row['kelas_grade']!=12) 
			{?>
                <th width="60px">Pengetahuan</th>
                <th width="60px">Ketrampilan</th>
		...
		foreach ($resultset['data'] as $idx => $item): 
			if ($item['kategori_nama'] != $ktg_nama):
				...
				if($row['kelas_grade']==12)
				{
					...
					if($item['kategori_kode']=='C3. Dasar'):
						// echo "<td colspan=\"6\"><strong>Kelompok C (Peminatan)</strong></td>";
						echo "<td align=\"left\" valign=\"middle\"><strong>&nbsp;&nbsp;</strong></td>";
						echo "<td colspan=\"4\"><strong>C. Muatan Peminatan Kejuruan</strong></td>";
						echo "</tr><tr>";
					endif;
					...
					if($item['kategori_kode']=='KelC1'):
						// echo "<td colspan=\"6\"><strong>Kelompok C (Peminatan)</strong></td>";
						echo "<td align=\"left\" valign=\"middle\"><strong>&nbsp;&nbsp;</strong></td>";
						echo "<td colspan=\"5\"><strong>C. Muatan Peminatan Kejuruan</strong></td>";
						echo "</tr><tr>";
					endif;
					if($item['kategori_kode']=='KelC2'):
						echo "<td align=\"left\" valign=\"middle\"><strong>&nbsp;&nbsp;</strong></td>";
						...
						echo "<td colspan=\"5\"><strong>{$item['kategori_nama']}</strong></td>";
			...
			*/
			...
			if($row['kelas_grade']!=12) 
			{
				echo "<td valign=\"middle\" align=\"center\"><div align=\"center\">".round($item['mid_teori'],0)." </div></td>";
				echo "<td valign=\"middle\" align=\"center\"><div align=\"center\">".round($item['mid_praktek'],0)."</div></td>";
				echo "<td valign=\"middle\" align=\"center\"><div align=\"center\">".$item['mid_pred_sikap']."</div></td>";
			}else{
	...
	<p align="right" class="style6" style="padding-right:50">
		...
		<tr>
			...
			<td width="38%" align="center" valign="top">
				<p class="style6">
					...
					<br/>
					<br/>
					<!----Drs. Ariawan Sudagijono, M. Kom        Nining Tri Palupi, S.Pd., M.Pd.-->
					<?= $row['kepsek_nama']?>
