...
$ket_laporan = "LAPORAN HASIL BELAJAR PESERTA DIDIK TENGAH ";
	...
	$jarak_enter="<br/>";
	$ket_laporan = "LAPORAN HASIL PENILAIAN TENGAH ";
...
<table border="0" style="width: 100%;">
  <tr>
	...
	<td width="850" align="center" valign="top"><span class="style13"><span class="style19">PEMERINTAH PROVINSI JAWA TENGAH<br />
      ...
      <span class="style18">SMK NEGERI 6 SEMARANG</span><br />
      <span class="style17">Jl. Sidodadi Barat No.8 Semarang 50124<br/>
       Telp.(024) 8312438<br />
				Website: www.smkn6smg.sch.id  Email : smkn6smg@yahoo.com</span></td>
    <td width="140" align="left" valign="top"><img src="<?=APP_ROOT?>/images/logo/<?=APP_SCOPE?>/smkn6smg.jpg" width="174" /></td>
  </tr>
</table>
    ...
    <br/>
 	    <table border="0" style="width: 100%;">
          <tr>
            ...
            <td width="900px" valign="top" class="style17"><b><?php echo strtoupper($row_per_siswa['siswa_nama']); ?></b> </td>
		...
		foreach ($resultset['data'] as $idx => $item): 
			 if ($item['kategori_nama'] != $ktg_nama):
				...
				<?php elseif($item['kategori_kode']=='mulok'):?>
				 ...
				 <tr>
					  <td valign="middle" colspan="7"><div class="style3"><b> A. Muatan Nasional </b></div></td>
				  </tr>
                  
                  <?php elseif($item['kategori_kode']=='KelB'):?>
				 <tr>
					  <td valign="middle" colspan="7"><div class="style3"><b> B. Muatan Kewilayahan </b></div></td>
				  </tr>
                  
                  <?php elseif($item['kategori_kode']=='C1 X'):?>
				 
                  <tr>
                  	   <td valign="middle" colspan="7"><div class="style3"><b> C1. Dasar Bidang Keahlian</b></div></td>
				  </tr>
                  
                  <?php elseif($item['kategori_kode']=='C2. X'):?>
				 <tr>
                  	   <td valign="middle" colspan="7"><div class="style3"><b> C2. Dasar Program Keahlian</b></div></td>
				  </tr>
				<?php else:?>
				 <tr>
