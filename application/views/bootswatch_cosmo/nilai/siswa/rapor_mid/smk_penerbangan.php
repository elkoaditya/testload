...
//        $mapel_jenis_nilai[$no_judul_mapel] += $mapel_nilai[$no_judul_mapel];
    ...
    <table cellspacing="0" id="t-nilai" class="t-border" >
                    ...
                    if ($mapel_jenis[$set_b] == $set_a) {
                      ...
                      //  echo "<table class='t-siswa2' width='100%'><tr><td width='6%' valign='top'> &nbsp;".$no_mapel . ". </td>";
                       ...
                       // echo "</td>";
						...
						// KKM
						// Utkl kls X dan XI 
						// Kelompok A dan B KKM 70, Kelompok C 75
						// Utk kls XII KKM Semua mapel 75
						if($no_kategori >=3){
							$mapel_kkm[$set_b]=75;
						}
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
            <tr>
                <td width="40%"></td>
                <td width="50%" class="t-border">Nilai Prestasi Rata-Rata (I + II + 2 III) / 4 </td>
                <td width="5%" class="t-border" align="center"> <?php echo ($keseluruhan_rata2nilai / 4); ?></td>
                <td width="5%"></td>
            </tr>
        </table>
        <?php }else{?>
