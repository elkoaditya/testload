...
<table border="0" style="width: 100%;">
    <tr>
        <td width="92px" valign="top" class="style16"><b>Nama Siswa</b></td>
        <td width="10px" valign="top" class="style16">:</td>
        <td width="42%" valign="top" class="style16"><b><?php 
        ...
        <td width="125px" valign="top" class="style16"><b>Kelas / Semester</b></td>
        <td width="10px" valign="top" class="style16">:</td>
        <td valign="top" class="style16"><b><?php 
    ...
    <tr>
        ...
        <td valign="top" class="style16">:</td>
<!--        <td valign="top" class="style16"><b><?php //echo $resultset['data'][0]['ta'] . '/' . ($resultset['data'][0]['ta'] + 1); ?></b> </td>-->
        <td valign="top" class="style16"><b>
