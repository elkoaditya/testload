...
<table border="0" style="width: 100%;">
  ...
  <tr>
    ...
    <td  valign="top"><!--Pengumuman Hasil Ujian Nasional & <br>
	  ...
	  Pengumuman Kelulusan tahun 2018
	</td>
  </tr>
</table>
<br><br>
...
<table border="0" style="width: 100%;">
  ...
  <tr>
    ...
    <td  valign="top">
		...
		<!--Ujian Sekolah Bertaraf Nasional -->
		Ujian Sekolah Berstandar Nasional SMA Setiabudhi tahun pelajaran <?=$row["ta_nama"]; ?>.
	</td>
  </tr>
  <tr>
    <td width="10%"  valign="top" align="center">3.</td>
    <td  valign="top">
		Rapat pleno Dewan Guru SMA Setiabudhi Semarang tanggal  <?=$tanggal_surat_keputusan_panutan?>.
	</td>
  </tr>
</table>
<br>
