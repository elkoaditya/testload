	...
	<tr>
		...
		<td width="38%" align="left" valign="top">
			<p class="style11">
				...
				<?php echo '<img src="'.APP_ROOT.'/content/sman8smg/ttd/'.$guru_id.'.png" height="80" style="margin-top:-7; margin-bottom:-6; position: absolute; top: 5px; left: 5px; z-index: 1" /><br>';?>
