...
// tabel nilai siswa
if($kelas_grade==11 || $kelas_grade==12){
	...
	$table_nilsis_akhir = array(
		...
		'data' => array(
			...
			' &nbsp;' => '&nbsp;',
			div_right('<b>Teori &nbsp;</b>') => array('nas_teori', 'display_nilai', 'suffix' => ' &nbsp;'),
			div_right('<b>Praktek &nbsp;</b>') => array('nas_praktek', 'display_nilai', 'suffix' => ' &nbsp;'),
			'<div align="center"><b>Sikap</b></div>' => array(
				'pred_sikap',
				//'formnil_predikat',
	...
	$table_nilsis_akhir = array(
		...
		'data' => array(
			...
			'L/P' => array('siswa_gender', 'strtoupper'),
			' &nbsp;' => '&nbsp;',
			div_right('<b>Nilai Teori &nbsp;</b>') => array('nas_teori', 'display_nilai', 'suffix' => ' &nbsp;'),
			div_right('<b>Pred Teori &nbsp;</b>') => array('pred_teori', 'display_nilai', 'suffix' => ' &nbsp;'),
			div_right('<b>Nilai Praktek &nbsp;</b>') => array('nas_praktek', 'display_nilai', 'suffix' => ' &nbsp;'),
			div_right('<b>Pred Praktek &nbsp;</b>') => array('pred_praktek', 'display_nilai', 'suffix' => ' &nbsp;'),
			'<div align="center"><b>Sikap</b></div>' => array(
				'pred_sikap',
				//'formnil_predikat',
				'prefix' => '<div align="center">',
	...
	<body class="preview" id="top" data-spy="scroll" data-target=".subnav" data-offset="80">
		...
		<div class="container">
			...
			<div id="tabel">
				...
				for ($i = 1; $i <= 10; $i++)
					echo "<th colspan='4'><div align='center'><b>KD {$i}</b></div></th>" . NL;
