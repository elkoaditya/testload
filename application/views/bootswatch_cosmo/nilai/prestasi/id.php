...
$pills[] = array(
	...
	'uri'	 => "data/non_akademik/prestasi/id/{$row['prestasi_id']}",
	'attr'	 => 'title="lihat detail prestasi"',
);

$pills_nisisxkul = array();

if ($row['semester_id'] == $semaktif['id'] && ($admin OR $user["id"] == $row["pembina_id"]))
	$pills_nisisxkul[] = array(
		'label'	 => '<i class="icon-upload"></i>Impor',
		'uri'	 => "nilai/prestasi/impor/" . $row['id'],
		'attr'	 => 'title="impor keterangan prestasi siswa"',
		'class'	 => 'active',
	);
...
<html lang="en">
	...
	<?php $this->load->view(THEME . "/-html-/head", array('title' => 'Detail Penilaian Prestasi')); ?>
