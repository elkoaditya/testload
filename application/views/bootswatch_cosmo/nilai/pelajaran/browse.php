...
function display_count($nilai)
{
	...
	return $font.div_right(formnil_angka($nilai)).$fontn;
...
$table = array(
	...
	'data'				 => array(
		...
		'Jml MID Teori Kosong'		=> array('cmid_teori_kosong', 'display_count'),
		'Jml MID Praktek Kosong'		=> array('cmid_praktek_kosong', 'display_count'),
		'Jml Akhir Teori Kosong'		=> array('cakhir_teori_kosong', 'display_count'),
		'Jml Akhir Praktek Kosong'		=> array('cakhir_praktek_kosong', 'display_count'),
		
		'Jml Deskp Teori Kosong'		=> array('cakhir_teori_kosong', 'display_count'),
		'Jml Deskp Praktek Kosong'		=> array('cakhir_praktek_kosong', 'display_count'),
