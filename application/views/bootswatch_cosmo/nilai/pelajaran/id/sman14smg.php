...
$pills_fbar['expor_usbn'] = array(
	'label' => '<i class="icon-download"></i>Download Form USBN',
	'uri' => "nilai/pelajaran/expor_usbn/{$row['id']}/k13" . array2qs(),
	'attr' => 'title="download excel form nilai pelajaran" target="_blank"',
	'class' => 'active',
);
$pills_fbar['impor_usbn'] = array(
	'label' => '<i class="icon-upload"></i>Impor USBN',
	'uri' => "nilai/pelajaran/impor_usbn/{$row['id']}/k13",
	'attr' => 'title="impor daftar nilai pelajaran"',
	'class' => 'disabled',
);

$pills_fbar['expor'] = array(
	'label' => '<i class="icon-download"></i>Download Form',
	'uri' => "nilai/pelajaran/expor/{$row['id']}/k13" . array2qs(),
	'attr' => 'title="download excel form nilai pelajaran" target="_blank"',
	'class' => 'active',
);
...
if ($admin OR ( $pengajar && $semaktif['id'] == $row['semester_id']))
{
	...
	$pills_fbar['impor_usbn']['class'] = 'active';
}
...
$table_nilsis_akhir = array(
	...
	'data'				 => array(
		...
		div_right('<b>PTS</b>')					 => array('uts', 'display_nilai'),
		'&nbsp;'								 => '&nbsp;',
		...
		div_right('<b>PAS</b>') => array('uas', 'display_nilai'),
		' &nbsp; '								 => '&nbsp;',
		div_right('<b>USBN Akhir &nbsp;</b>') 	=> array('usbn_akhir', 'display_nilai', 'suffix' => ' &nbsp;'),
		div_right('<b>USBN Teori &nbsp;</b>') 	=> array('usbn_teori', 'display_nilai', 'suffix' => ' &nbsp;'),
		div_right('<b>USBN Praktek &nbsp;</b>') => array('usbn_praktek', 'display_nilai', 'suffix' => ' &nbsp;'),
