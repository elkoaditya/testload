...
$pills_kiri[] = array(
	'label'	 => 'Detail Video Call',
	'uri'	 => "kbm/vidcall/id/{$row['id']}",
	'attr'	 => 'title="kembali ke detail Video Call"',
);

// informasi Video Call
...
$btn_back = a("kbm/vidcall/id/{$row['id']}", ' <i class="icon-circle-arrow-left icon-white"></i> Kembali ke detail Video Call', 'class="btn btn-info "');
...
<html lang="en">
	...
	<?php $this->load->view(THEME . "/-html-/head", array('title' => "Reuse Video Call #{$row['id']}")); ?>
	...
	<body class="preview" id="top" data-spy="scroll" data-target=".subnav" data-offset="80">
		...
		<div class="container">
			...
			<div id="tabel">
				...
				echo '<legend>Master Video Call</legend>';
