...
$input['umum'] = array(
		...
		'tipe' => array(
				...
				'options' => array(
						'latihan' => 'Latihan',
						'ulangan' => 'Ulangan',
						'ulangan_tengah_semester' => 'Penilaian Tengah Semester',
						'ulangan_akhir_semester' => 'Penilaian Akhir Semester',
		...
		'metode' => array(
				...
				'options' => array(
						...
						'opsi_tampil_ABC' => 'Opsi Jawaban Urut (Tampil ABC)',
						'opsi_tanpa_ABC' => 'Opsi Jawaban Acak',
		...
		'kisi_kisi' => array(
				'kisi_kisi',
				'label' => 'Masuk Kisi-kisi',
				'type' => 'checkbox',
				'name' => 'kisi_kisi',
				'id' => 'kisi_kisi',
				'value' => 1,
				'checked' => (bool) ($row['kisi_kisi']),
		...
		'plus_isian' => array(
				...
				'id' => 'plus_isian',
				'value' => 1,
				'checked' => (bool) ($row['plus_isian']),
				'style' => 'margin: 10px 10px 14px 0;',
		),
		'plus_uraian' => array(
				'plus_uraian',
				'label' => 'Tambah Soal Uraian',
				'type' => 'checkbox',
				'name' => 'plus_uraian',
				'id' => 'plus_uraian',
				'value' => 1,
...
// jadwal evaluasi
				...
				// if($user['id'] === 11){
					...
					echo '<table id="table-jadwal" class="table table-bordered table-striped table-hover">';
					echo '<thead><tr><td> ____ </td><td>Mulai</td><td>Selesai</td><td>Durasi</td><td>Limit Akses</td></tr></thead>';
					echo "<tbody class=\"\">";
...
// form button
		...
		addon('tinymce');
		?>
		<div id="opsi_pelajaran"> AAAAAAAAAAAAAAAAAAAAAAAA</div>

		<script type="text/javascript">

		var json_kelas_id = <?php echo $json_kelas_id?>;
		<?php $json_opsi_kkm = json_encode($opsi_kkm); ?>
		var opsi_kkm = <?php echo $json_opsi_kkm?>;
		document.getElementById("opsi_pelajaran").innerHTML = "BBB"+JSON.stringify(opsi_pelajaran);
			...
			$(function() {    
				...
				$("#pelajaran_id").change(function() {
					...
					document.getElementById("kkm").value = opsi_kkm[pid];
				});
				//$("#pelajaran_id").change();
