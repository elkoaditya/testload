...
{
	return a("/kbm/evaluasi_ljs/surveillance?evaluasi_id=".$_COOKIE['evaluasi_id']."&kelas_id=".$row['kelas_id']."&detail_jawab=1", 'ABSENSI & SURVEILLANCE', 'class="btn btn-success" title="memata-matai pengerjaan"');
}
