...
$input['bobot_nilai'] = array(
	'bobot_pilgan' => array(
			'bobot_pilgan',
			'label' => 'Bobot Nilai Pilihan Ganda',
			'type' => 'input',
			'name' => 'bobot_pilgan',
			'id' => 'bobot_pilgan',
			'class' => 'input input-large',
			'placeholder' => 'bobot nilai pilgan',
			'title' => 'bobot nilai pilgan',
	)
);

if($row['plus_isian']==1){	
	$input['bobot_nilai']['bobot_isian'] = array(
		'bobot_isian',
		'label' => 'Bobot Nilai Isian',
		'type' => 'input',
		'name' => 'bobot_isian',
		'id' => 'bobot_isian',
		'class' => 'input input-large',
		'placeholder' => 'bobot nilai isian',
		'title' => 'bobot nilai isian',
	);
}

if($row['plus_uraian']==1){	
	$input['bobot_nilai']['bobot_uraian'] = array(
		'bobot_uraian',
		...
		'id' => 'bobot_uraian',
		'class' => 'input input-large',
		'placeholder' => 'bobot nilai uraian',
		'title' => 'bobot nilai uraian',
	);
}
// buttons
...
// input umum
				...
				foreach ($input['bobot_nilai'] as $inp):
