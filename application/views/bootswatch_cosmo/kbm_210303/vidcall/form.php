...
$input = array(
		...
		'jenis_brand' => array(
				'jenis_brand',
				'label' => 'Pilihan Video Call',
				'type' => 'dropdown',
				'name' => 'jenis_brand',
				'id' => 'jenis_brand',
				'extra' => 'class="input-large select" id="jenis_brand"',
				'options' => array(
						1 => 'ZOOM',
						2 => 'JITSI',
				),
...
*/
if(!isset($row['tanggal_publish'])){
	$date_now = date("Y-m-d h:00");
	$row['tanggal_publish'] 	= $date_now;
}else{
	$row['tanggal_publish'] 	= datefix($row['tanggal_publish'], 'Y-m-d H:i');
}

if(isset($row['tanggal_tutup'])){
	$row['tanggal_tutup'] 		= datefix($row['tanggal_tutup'], 'Y-m-d H:i');
}
  ...
  <body class="preview" id="top" data-spy="scroll" data-target=".subnav" data-offset="80">
    ...
    <div class="container">
			...
			<div id="tabel">
				...
				if(APP_SCOPE != 'smkn7smg'){
					unset($input['jenis_brand']['extra']);
					unset($input['jenis_brand']['options']);
					$input['jenis_brand']['type'] = 'hidden';
					$input['jenis_brand']['value'] = 2;
				}
