...
$breadcrumbs = array(
		...
		"#{$row['id']}" => "kbm/bank_soal/form?id={$row['id']}",
		'#delete'
);
$btn_back = a("kbm/bank_soal", ' <i class="icon-circle-arrow-left icon-white"></i> Kembali ke bank soal', 'class="btn btn-info "');
