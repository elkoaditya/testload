...
if ($user['role'] == 'siswa'):
	...
	$detail['tambahan'] = array(
		...
		'Tambah Kop'		 => 'kop',
		'Pakai Webcam'		 => array('show_webcam', array('<span style="color:#F00;">TIDAK</span>', '<span style="color:#00F;">YA</span>')),
		'Tambah Soal Isian Singkat'		 => array('plus_isian', array('<span style="color:#F00;">TIDAK</span>', '<span style="color:#00F;">YA</span>')),
		'Tambah Soal Uraian'		 => array('plus_uraian', array('<span style="color:#F00;">TIDAK</span>', '<span style="color:#00F;">YA</span>')),
