...
<div id="demo">
    ...
    <div class="user">
		<a href="#link_soal_dok" >
		<div id="nomer_soal_dok" class="img-thumbnail" style="margin-left:4px" >
			<table>
			 <tr>
			...
			<div id="tabel">
				...
				echo '</div>
					...
					<div class="prototype-wrapper"> <!-- A wrapper to emulate use in a webpage and center align -->
						...
						echo '<fieldset style="margin-left:-15px; margin-right:-15px">';
						echo "<legend>
						<div id='soal".$no_soal."'>&nbspSoal ::&nbsp; " . ($idx + 1) . "</div>
						</legend>";
						...
						if ($evaluasi['pilihan_jml'] > 1 && is_array($soal['opsi'])):
							echo '<table class="table table-bordered table-striped table-hover"><tr>' . NL;
