...
$pills[] = array(
		'label' => '<i class="icon-arrow-left"></i> Daftar Materi',
		'uri' => "kbm/materi",
		'attr' => 'title="kembali ke tabel materi"',
		'class'	 => 'active',
);
$pills[] = array(
		'label' => '<i class="icon-arrow-left"></i> Detail Materi',
...
if($user['role']!='siswa'){
	$pills[] = array(
			'label' => '<i class="icon-arrow-left"></i> Kembali Pembaca Materi',
			'uri' => "kbm/materi/pembaca/{$row['id']}",
			'attr' => 'title="kembali ke tampilan pembaca materi"',
			'class'	 => 'active',
	);
}
		...
		'data' => array(
				...
				'Komentar Terakhir' => array(
						...
						'suffix' => array(
								...
								'</span>',
								div('class="pull-right soal-pills"'),
								'<a href="'.base_url().'kbm/materi/komentar_hapus/',
								array('komentar_id'),
								'/',
								array('id'),
								'" class="btn btn-small btn-warning">Delete</a>',
								'</div>'
						),
				),
		),
...
$bar_pills = pills($pills, 'class="nav nav-pills"');
$bar_pencarian = '<div>'
