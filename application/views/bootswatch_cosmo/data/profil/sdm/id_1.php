...
if ($admin_user)
	$pills[] = array(
			'label' => '<i class="icon-search"></i>Akun',
			'uri' => "data/user/id/{$row['id']}",
  ...
  <body class="preview" id="top" data-spy="scroll" data-target=".subnav" data-offset="80">
    ...
    <div class="container">
			...
			<div id="tabel">
				...
				if ($sdm_ybs):
					echo a("kbm/materi/form", '<i class="icon-star"></i>Susun Materi Baru', 'class="btn btn-large btn-primary"') . '&nbsp; ';
					echo a("kbm/evaluasi/form", '<i class="icon-star"></i>Susun Evaluasi Baru', 'class="btn btn-large btn-primary"') . '&nbsp; ';

				endif;

				echo '<a href="#" id="cmd-info-toggle" class="btn btn-large btn-info">' . $toggle_label . '</a>';
				echo '</div>';
				echo pills($pills);
    ...
    <script>
			$('#cmd-info-toggle').click(function() {
				...
				if (txt === 'Profil Detail') {
					$(this).html('Profil Ringkas');
					$('.data-ringkas').slideUp(200);
					$('.data-lengkap').slideDown(200);

				} else {
					$(this).html('Profil Detail');
