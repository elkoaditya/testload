	...
	function query_1( $rowset='' )
	{
		...
		if ($d['user']['role'] == 'siswa'):
			...
			$query['join'][] = array(
				...
				'absensi.evaluasi_id = evaluasi.id AND absensi.user_id = nilai.user_id ', 
				'left'
			);
			...
			$query['select']['waktu_absensi'] 		= 'absensi.time';
			$query['select']['kode_image_absensi'] 	= 'absensi.kode';
			$query['select']['image_absensi'] 		= 'absensi.image';
