...
class Cm_nilai_pelajaran_ktsp extends MY_Model
{
	...
	function expor()
	{
		...
		if (TRUE)
		{
			...
			$array_1kognitif = array('1','3','4','5','6','7', '8','13','14','15','16','33','44');
			//seni bud
	...
	function expor_template($nipel_id,$jenis_aspek)
	{
		...
		{	$template_kurikulum = $tamplate_nipel."rekap_nilai_ktsp_2aspek_kelompok1.xlsx";		}
		elseif($jenis_aspek == '2psiko')
		{	$template_kurikulum = $tamplate_nipel."rekap_nilai_ktsp_2aspek_kelompok2.xlsx";	}
