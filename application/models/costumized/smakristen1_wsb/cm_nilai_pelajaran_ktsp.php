...
class Cm_nilai_pelajaran_ktsp extends MY_Model
{
	...
	function expor()
	{
		...
		$_cell_input = array(
					...
					"M11:N60",
					//U R
					"P11:Q60", "S11:T60", "V11:W60", "Y11:Z60", "AB11:AC60",
					"AE11:AF60", "AH11:AI60", "AK11:AL60", "AN11:AO60", "AQ11:AR60",
					//T
					"AT11:BC60", 
					//P
					"BE11:BX60", 
	...
	function expor_template($nipel_id)
	{
		...
		$template_kurikulum = APP_ROOT."content/".strtolower(APP_SCOPE)."/nilai-pelajaran/template_ktsp.xlsx";
