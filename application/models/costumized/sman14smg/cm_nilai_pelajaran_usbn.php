...
class Cm_nilai_pelajaran_usbn extends MY_Model
{
	...
	function expor()
	{
		...
		if (TRUE)
		{
			...
			$kelas_list = array();
			$excel_row_offset = 10;
			$excel_source = APP_ROOT."content/".strtolower(APP_SCOPE)."/nilai-pelajaran/template_usbn.xlsx";
		...
		foreach ($kelas_list as $_kls_id)
		{
			...
			excel_security_cell_lock($_sheet, 'A1:O72');
		...
		// output
		return excel_output_2007($excel_obj, "USBN {$d['row']['pelajaran_nama']}.xlsx");
