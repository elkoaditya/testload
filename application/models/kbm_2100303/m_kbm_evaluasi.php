...
class M_kbm_evaluasi extends MY_Model
{
	...
	public function __construct()
	{
		parent::__construct(array(
			'fields-umum'		 => array('nama', 'kkm', 'jml_kd','kop','show_webcam','plus_isian','plus_uraian','tipe','metode', 'show_kunci'),
...
INSERT INTO
	...
	(
		evaluasi_id,
		nomor, type, nilai_bonus, cuplikan,
		posisi_kd, audio, pertanyaan, pilihan_ganda, poin_min, poin_max, pilihan,
