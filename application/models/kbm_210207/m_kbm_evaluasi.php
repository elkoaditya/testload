...
class M_kbm_evaluasi extends MY_Model
{
	...
	var $filetypes2 = array('html','pdf','ppt','pptx','xls','xlsx','doc','docx','rtf');
	
	public function __construct()
	{
		parent::__construct(array(
			'fields-umum'		 => array('nama', 'kkm', 'jml_kd','kop','show_webcam','plus_uraian','tipe','metode', 'show_kunci'),
	...
	function query_1()
	{
		...
		$query = array(
			...
			//'order_by'	 => 'evaluasi.semester_id desc, pelajaran.nama, evaluasi.tipe desc',
...
INSERT INTO
	...
	(
		...
		, plus_uraian, detail_uraian, file,
		cuplikan, konten
	)
