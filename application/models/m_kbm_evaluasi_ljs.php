	...
	function surveillance($index = 0, $limit = 50){
		...
		$query = array(
				'select' => array(
						//'evanil.*',
						'kelas_nama'	=> 'kelas.nama',
						'wali_nama'		=> "trim(both ' ,' from concat_ws(' ', wali.prefix, wali.nama, wali.suffix))",
						'siswa_id' 		=> 'siswa.id',
						'siswa_nis' 	=> 'siswa.nis',
						'siswa_nisn' 	=> 'siswa.nisn',
						'siswa_nama' 	=> 'siswa.nama',
						...
						'evaluasi_mulai'	=> 'evakel.evaluasi_mulai',
						'evaluasi_ditutup'	=> 'evakel.evaluasi_ditutup',
						'evaluasi_durasi'	=> 'evakel.evaluasi_durasi',
				),
				...
				'join' => array(
						...
						array('kbm_evaluasi_kelas evakel', 'evanil.evaluasi_id = evakel.evaluasi_id AND kelas.id = evakel.kelas_id ', 'left'),
