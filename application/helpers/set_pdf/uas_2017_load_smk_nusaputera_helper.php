...
function header_2017_v1($row,$row_per_siswa)
{
	$smster_nama = '2 / Genap';
			...
			$html .= ' 
				<table id="t-nilai" >
					...
					<tr>
						...
						<td class="sub-kategori"><b>Kriteria Ketuntasan Minimal (KKM) = 75</b></td>
					</tr>
					<tr>
						<td></td>
						<td>
...
function table_interval_kkm_v2()
{
	...
	$html .='		<tr>
			...
			<td class="field-nilai t-border" align="center"> < 75 </td>
			<td class="field-nilai t-border" align="center"> 75 ≤ n < 81</td>
			<td class="field-nilai t-border" align="center"> 81 ≤ n < 91 </td>
