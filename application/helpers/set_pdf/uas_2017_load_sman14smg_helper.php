...
function ekstrakurikuler_2017_v2($ekskul_result,$color_menu='')
{
	$html='
      <table cellspacing="0" class="t-border" width="100%" >
        <tr>
        	<td  class="t-border field-nilai3 '.$color_menu.'" align="center" valign="middle" width="20px"> <b>No</b></td>
            <td  class="t-border field-nilai3 '.$color_menu.'" align="center" valign="middle" width="26%"> <b>Kegiatan</b></td>
			<td  class="t-border field-nilai3 '.$color_menu.'" align="center" valign="middle" width="14%"> <b>Predikat</b></td>
            <td  class="t-border field-nilai3 '.$color_menu.'" align="center" valign="middle" width=> <b>Deskripsi</b></td>
        </tr>
        ';
		...
		foreach ($ekskul1 as $_idx => $_row)
        {
			if(strtolower($_row['ekskul_nama'])=='pramuka')
			{
				...
				$html.= '<tr>' . NL;
				$html.= "<td class=\"t-border field-nilai3\" valign=\"top\" align=\"right\" >" . $no . ".</td>" . NL;
				$html.= "<td class=\"t-border field-nilai3\" valign=\"top\" >{$_row['ekskul_nama']}</td>" . NL;
				/*if($_row['keterangan']!='')
				{	$html.= "<td class=\"t-border field-nilai\" valign=\"top\">{$_row['nilai']}. {$_row['keterangan']}</td>" . NL;	}
				else
				{	$html.= "<td class=\"t-border field-nilai\" valign=\"top\">{$_row['nilai']}. {$set_ekskul_keterangan} </td>" . NL;	}
				*/
				...
				$html.= "<td class=\"t-border field-nilai3\" valign=\"top\" align=\"center\" > {$set_ekskul_keterangan}</td>" . NL;	
				$html.= "<td class=\"t-border field-nilai3\" valign=\"top\" align=\"center\" >{$_row['keterangan']}</td>" . NL;
				$html.= '</tr>' . NL;
			}
		}
        ...
        {
            $html.= '<tr>' . NL;
			$html.= "<td class=\"t-border field-nilai3\" valign=\"top\" align=\"center\" >-</td>" . NL;
            $html.= "<td class=\"t-border field-nilai3\" valign=\"top\" align=\"center\">-</td>" . NL;
            $html.= "<td class=\"t-border field-nilai3\" valign=\"top\">-</td>" . NL;
			$html.= "<td class=\"t-border field-nilai3\" valign=\"top\">-</td>" . NL;
            $html.= '</tr>' . NL;
        }
...
function prestasi_2017_v1($prestasi_result,$color_menu='')
{
	$html = '
      <table cellspacing="0" class="t-border" width="100%" >
        <tr>
        	<td  class="t-border field-nilai3 '.$color_menu.'" align="center" valign="middle" width="20px"> <b>No</b></td>
            <td  class="t-border field-nilai3 '.$color_menu.'" align="center" valign="middle" width="30%"> <b>Jenis Prestasi</b></td>
            <td  class="t-border field-nilai3 '.$color_menu.'" align="center" valign="middle" width=> <b>Keterangan</b></td>
        </tr>';
        ...
        foreach ($prestasi_result['data'] as $_idx => $_row)
        {
			if($_row['prestasi_nama']!='')
			{
				...
				$html.= '<tr>' . NL;
				$html.= '<td class="t-border field-nilai3" valign="top" align="right" >' . $no . '</td> '. NL;
				$html.= '<td class="t-border field-nilai3" valign="top" >'. $_row['kegiatan_prestasi_nama'].'</td>' . NL;
				$html.= '<td class="t-border field-nilai3" valign="top">'.$_row['prestasi_nama'].'</td>' . NL;
				$html.= '</tr>" . NL';
			}
        }
...
function ketidakhadiran_2017_v1($ketidakhadiran)
{
	...
	<table cellspacing="0" class="t-border" width="50%" >
        ...
        <tr>
            <td width="50%" class=" field-nilai3">Sakit</td>
            <td class="t-border field-nilai3"> :  '.$absen_s .'</td>
        </tr>
        <tr>
            <td class="t-border field-nilai3">Ijin</td>
            <td class="t-border field-nilai3"> :  '.$absen_i .'</td>
        </tr>
        <tr>
            <td class="t-border field-nilai3">Tanpa Keterangan</td>
            <td class="t-border field-nilai3"> : '.$absen_a .'</td>
        </tr>
    </table>';
	return $html;
}
...
function footer_2017_sman14_v1($data)
{
