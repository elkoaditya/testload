...
function pdfview_2017_sma_michael_v2($id_nilai_siswa,$resultset_array,$deskripsi_pelajaran,$ekskul_result_array,$prestasi_result_array,$org_result_array,$row,$jumlah_rapor,$page_sikap = 0,$background = 0) {
...
function pdfview_2017_sma_michael_v3($id_nilai_siswa,$resultset_array,$deskripsi_pelajaran,$ekskul_result_array,$prestasi_result_array,$org_result_array,$row,$jumlah_rapor,$page_sikap = 0,$background = 0) {
	...
	$header = '		<div id="header_1" class="header">';
	$header .= 		header_2017_v3($row,$row_per_siswa);
	$header .= '	</div>';
