		...
		<table width="100%" border="0" style="width: 100%;">
			<tr>
				<td width="13%" valign="top" >
					<span class="style1"><b>Nama Siswa</b></span> </td>
				<td width="1%" valign="top">
					<span class="style1">:</span></td>
				<td valign="top" width="'.$width_nama.'">
					<span class="style1"><b>'.$cetak_nama.'</b></span></td>
				<td width="17%" valign="top">
					<span class="style1"><b>Kelas/Semester</b></span></td>
				<td width="1%" valign="top">
					<span class="style1">:</span></td>
				<td valign="top"><span style="text-transform:uppercase;">
					<span class="style1"><b>'.$row["kelas_nama"].'/'.$smster_nama.'</b></span></td>
			</tr>
			<tr>
				<td valign="top">
					<span class="style1"><b>NIS</b></span></td>
				<td width="1%" valign="top">
					<span class="style1">:</span></td>
				<td valign="top">
					<span class="style1"><b>'.$row_per_siswa["siswa_nis"].'</b></span></td>
	
				<td valign="top">
					<span class="style1"><b>Tahun Pelajaran</b></span></td>
				<td width="1%" valign="top">
					<span class="style1">:</span></td>
				<td valign="top">
					<span class="style1"><b>'.str_replace("/"," - ",$row["ta_nama"]).'</b></span></td>
			</tr>
...
function header_2017_v2($row,$row_per_siswa)
{
	...
	$width_nama='47';
	if(strlen($row_per_siswa['siswa_nama']) > 38)
	{
		$width_nama = '52';
	}
	...
	<div id="header_1" class="header">
		<table width="100%" border="0" style="width: 100%;">
			<tr>
			  <td width="14%"	valign="top"><span class="style1">Nama</span> </td>
			  <td width="1%"	valign="top"><span class="style1">:</span></td>
			  <td width="'.$width_nama.'%" 	valign="top"><span class="style1"><em>'.$row_per_siswa['siswa_nama'].'</em></span></td>
	...
	for ($i = 1; $i <= 2; $i++) {
		...
		$html .= 		$header;
			...
			$html .= ' 
				<table id="t-nilai" >
					...
					<tr>
						...
						<td class="sub-kategori"><b>Kriteria Ketuntasan Minimal (KKM) = 65</b></td>
					</tr>
					<tr>
						<td></td>
						<td>
			...
			//{
							...
							{
								$cetak_des = 1;
		$html .=						"<td class=\"field-deskripsi2 t-border\" valign=\"top\" align=\"left\">{$item['cat_teori']}</td>" . NL;
							}else{
			...
			//}else{ 
							...
							{
								$cetak_des = 1;
		$html .=						"<td class=\"field-deskripsi2 t-border\" valign=\"top\" align=\"left\">{$item['cat_praktek']}</td>" . NL;
							}else{
...
function head_table_nilai_2017_v2($type=0)
{
	...
	$html .='
        ...
        <td class="thead-1 t-border " '.$set_rowspan.'  width="21%"><b>Mata Pelajaran</b></td>
...
function sikap_2017_v2($data,$row_per_siswa,$ktg_nama,$jml_row, $deskripsi_array)
{
    ...
    <div class="thead-1" ><b>1.Sikap Spiritual</b></div>
      <table cellspacing="0" class="t-border" width="100%" >
        <tr>
        	<td class="t-border field-sikap" align="center" valign="top" height="30px" width="20%"> Predikat </td>
        	<td class="t-border field-sikap" align="center" valign="top" height="30px" >Deskripsi </td>
			
        </tr>
        <tr>
        	<td class="t-border field-sikap" align="center" valign="top">'; 
		...
		$html .= '</td>
        	<td class="t-border field-sikap" align="left" valign="top" height="100px"> 
            ';
...
function table_interval_kkm_v2()
{
	...
	$html .='		<tr>
			<td class="field-nilai t-border" align="center"> 65 </td>
			<td class="field-nilai t-border" align="center"> < 65 </td>
			<td class="field-nilai t-border" align="center"> 65 ≤ n < 76</td>
			<td class="field-nilai t-border" align="center"> 76 ≤ n < 88 </td>
			<td class="field-nilai t-border" align="center"> 88 ≤ n < 100</td>
		';	
	...
	$html='
      <table cellspacing="0" class="t-border" width="100%" >
        <tr>
            ...
            <td  class="t-border field-nilai '.$color_menu.'" align="center" valign="middle" width="65%"> <b>Kegiatan Ekstrakurikuler</b></td>
            <td  class="t-border field-nilai '.$color_menu.'" align="center" valign="middle" width=> <b>Predikat</b></td>
        </tr>
        ';
        ...
        foreach ($ekskul_result['data'] as $_idx => $_row)
        {
			...
			$html.= "<td class=\"t-border field-nilai\" valign=\"top\" align=\"center\">{$_row['nilai']}</td>" . NL;
			/*if($_row['keterangan']!='')
	...
	$html .='       
		<tr>
			...
			<td colspan="3">
				<table>
					<tr>
						<td style="padding-left:70px;width: 100%;" align="center" >
							Mengetahui,<br>
							Kepala Sekolah
							<p>
								<br/><br/><br/><br/>';
