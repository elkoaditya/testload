...
function table_nilai_ktsp_v1_tarcisius($resultset)
{
	$html='
            ...
            <th >Deskripsi Kemajuan Belajar</th>
				...
				foreach ($resultset['data'] as $idx => $item): 
					 ...
					 if ($item['kategori_nama'] != $ktg_nama):
						$set_asci = 'A';
						if($item['kategori_kode']=='normatif'):
							$set_asci = 'I';
						elseif($item['kategori_kode']=='adaptif'):
							$set_asci = 'II';
						elseif($item['kategori_kode']=='produktif'):
							$set_asci = 'III';
		...
		$html.='
						 <tr>
							  <td align="center" valign="middle"><div class="style3"><b>'.$set_asci.'.</b></div></td>
							  <td valign="middle" colspan="6"><div class="style3" ><b>'.$item['kategori_nama'].'</b></div></td>
	...
	$html.='			
				<tr>
					<td align="center" valign="top">'.$mp_no.'.</td>
	...
	$html.=	'					
					...
					if ($item['pred_teori']=="" or is_null($item['pred_teori']) ) {
	$html.=	'			-';
					} else {
...
function table2_tarcisius_v1($row,$ekskul_result){
	...
	if(isset($row['kode_kepribadian'])){
		...
		$aspek_array = array(
				'kedisiplinan'	 => 'Kerajian',
				'kebersihan'	 => 'Kerapian',
				//'kesehatan'		 => 'Kesehatan',
				'tgjawab'		 => 'Sikap dan Tanggung Jawab',
				//'kesopanan'		 => 'Sopan Santun',
				//'percayadiri'	 => 'Percaya Diri',
				//'kompetitif'	 => 'Kompetitif',
				//'sosial'		 => 'Hubungan Sosial',
...
function absensi_tarcisius_v1($row){
		...
		$html = '';
		$html.= '<table cellspacing="0" id="t-kompetensi" border="1"  class="t-border" style="width: 100%;">';
...
function catatan_tarcisius_ktsp_v1($row){
	...
	if($row['note_walikelas']=='')
	{
		$row['note_walikelas']="<br/><br/>";
	}
	$html= '
...
function footer_ktsp_v2_tarcisius($data,$lembar)
{
    ...
    <table border="0" width="100%">
        <tr>
			...
			';
			if($data['semester_nama']=='genap')
			{

				$html .= '			<b>Keputusan</b><br>
						Dengan memperhatikan hasil yang dicapai <br>pada semester 1 dan 2 maka ditetapkan:<br><br>';
				$html .= '<div style=""><b>NAIK</b></div><br>';

				$html .= 'Ke tingkat / tahun ke '.($data['kelas_grade']-8).'<br>';
