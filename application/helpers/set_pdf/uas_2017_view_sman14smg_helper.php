...
function pdfview_2017_sman14smg_v1($id_nilai_siswa,$resultset_array,$deskripsi_pelajaran,$ekskul_result_array,$prestasi_result_array,$org_result_array,$row,$jumlah_rapor,$page_sikap = 0,$background = 0) {
	...
	$html .= 	footer_2017_sman14_v1($row);
	$html .= '	</htmlpagefooter>';
