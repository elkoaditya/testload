...
function pdfview_2017_smaissa1smg_v1($id_nilai_siswa,$resultset_array,$deskripsi_pelajaran,$ekskul_result_array,$prestasi_result_array,$org_result_array,$row,$jumlah_rapor,$page_sikap = 0,$background = 0) {
	...
	$html .= 			$header;
	$html .= 			nilai_cirikhusus_2017_v1($resultset,$row,$row_per_siswa,$deskripsi_array,$header,0,$page_sikap);
	$html .= '			<br/>';
	$html .= 			prestasi_bta_2017_v1($resultset,$row,$row_per_siswa);
	$html .= 			ttd_2017_v1($row,1);
	$html .= '		</div>';
		}
