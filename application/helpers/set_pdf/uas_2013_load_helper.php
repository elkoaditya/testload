...
function head_table_nilai_2013_sman14_v2($type=0)
{
	$set_rowspan = 'rowspan="2"';
	if($type != 0){
		$set_rowspan = '';
...
function head_table_nilai_2013_penerbad_v3()
{
	$html ='
	<tr>
        <td class="thead-1 t-border color-menu" rowspan="2" width="20px"><b>NO</b></td>
...
function ketidakhadiran_2013_penerbad_v1($ketidakhadiran)
{
	$absen_s = '0 hari';
	$absen_i = '0 hari';
	$absen_a = '0 hari';
...
function tableextra_2013_penerbad_v3($ekskul_result,$prestasi_result,$row_per_siswa,$nilai_catatan_walikelas,$row, $color_menu='')
{ 
	$html = '
	<table id="t-nilai" width="100%">   
         <tr>
         ...
         <tr>
          ...
          <td>
          	  ...
          	  '.ketidakhadiran_2013_penerbad_v1($row_per_siswa).'
...
//     $html .= '<br/><br/>';
    ...
    $html .=        	'</tr>' . NL;
					...
					//else if (($ktg_nama != NULL)&&(
					if(
						//((($item['kategori_kode'] == 'KelA')&& ($mp_no==4))&&($row['kelas_grade'] == 12)) ||
						//((($item['kategori_kode'] == 'KelA')&& ($mp_no==5))&&($row['kelas_grade'] != 12)) ||
						(($item['kategori_kode'] == 'KelA')&& ($mp_no==4)) ||
						((($item['kategori_kode'] == 'C1. XI')&& ($mp_no==1))&&($row['kelas_grade'] == 10)) )
...
function tablepdf_2013_sman14_v2($resultset,$row,$row_per_siswa,$deskripsi_array,$header,$type_return=0,$page_sikap=0,$background = 0,$kkm=70)
{
	$mp_no = 0;
	$ktg_ascii = 64;
	$ktg_nama = NULL;
...
function tablepdf_2013_sman14_v3($resultset,$row,$row_per_siswa,$deskripsi_array,$header,$type_return,$background)
{
    ...
    $html .= ' 
		<table id="t-nilai" >
			...
			<tr>
				...
				<td>
					<table cellspacing="0" id="t-nilai" class="t-border" >';
    $html .=	head_table_nilai_2013_sman14_v2($type_return);
   ...
   // $html .=            	"<td class=\"field-nilai t-border\" valign=\"top\" colspan=".$type_return_colspan2."><b>".$item['kategori_nama']."</b></td>" . NL;
    ...
    $html .=        	'</tr>' . NL;
					...
					else if( ($item['kategori_kode'] == 'KelB') && ($mp_no==8)) 						
                    {
    $html .=             '</tr>
					</table>                                
                </td>
    ...
    <div id="header_1" class="header">';
	$html .= header_2013_sman14_v2($row,$row_per_siswa);
	$html .= '
        </div>
		<table id="t-nilai" >
			<tr>
...
function tablepdf_2013_penerbad_v5($resultset,$row,$row_per_siswa,$deskripsi_array,$type_return,$background = 0 ,$input_kkm = 70)
{
	//kkm 75
	$range12_kelc = array(
...
//     $html .= '<br/><br/>';
     $html .= ' 
			...
			<tr>
				...
				<td>
					<table cellspacing="0" id="t-nilai" class="t-border" >';
    $html .=	head_table_nilai_2013_penerbad_v3();
					...
					if ( ($item['kategori_nama'] != $ktg_nama) ||
						...
						*/
						( ($item['kategori_kode'] == 'KelA') && ($mp_no==1)) ||
							...
							( ($item['kategori_kode'] == 'KelA') && ($mp_no==1)) ||
							( ($item['kategori_kode'] == 'KelB') && ($mp_no==2)) ||
							( ($item['kategori_kode'] == 'KelC2') && ($mp_no==0)) ||
							( ($item['kategori_kode'] == 'C3. Dasar') && ($mp_no==3)) ||
							( ($item['kategori_kode'] == 'MuatanN') && ($mp_no==1) && ($row_per_siswa['agama_id']!=1)) ||
							( ($item['kategori_kode'] == 'MuatanN') && ($mp_no==2) && ($row_per_siswa['agama_id']==1)) ||
							( ($item['kategori_kode'] == 'MuatanN') && ($mp_no==4)) ||
							( ($item['kategori_kode'] == 'MuatanN') && ($mp_no==6)) ||
							( ($item['kategori_kode'] == 'MuatanK') && ($mp_no==2)) ||
							( ($item['kategori_kode'] == 'MuatanK') && ($mp_no==4))							
					)
                    {
                        $ktg_ascii++;
						if ($item['kategori_nama'] != $ktg_nama){
    ...
    $html .=                "<td class=\"field-nilai t-border\" valign=\"top\" colspan=\"9\"><b>".$item['kategori_nama']."</b></td>" . NL;
							...
							( ($item['kategori_kode'] == 'KelA') && ($mp_no==1)) ||
							( ($item['kategori_kode'] == 'KelA') && ($mp_no==4)) ||
							( ($item['kategori_kode'] == 'KelB') && ($mp_no==0)) ||
							( ($item['kategori_kode'] == 'KelC2') && ($mp_no==0)) ||
							//( ($item['kategori_kode'] == 'MuatanN') && ($mp_no==1) && ($row_per_siswa['agama_id']!=1)) ||
							//( ($item['kategori_kode'] == 'MuatanN') && ($mp_no==2) && ($row_per_siswa['agama_id']==1)) ||
							( ($item['kategori_kode'] == 'MuatanN') && ($mp_no==2)) ||
							( ($item['kategori_kode'] == 'MuatanN') && ($mp_no==3)) ||
							( ($item['kategori_kode'] == 'MuatanK') && ($mp_no==1)) ||
							( ($item['kategori_kode'] == 'MuatanK') && ($mp_no==2)) 
						)							
                        {
    ...
    $html .=        		"<td class=\"field-nilai t-border\" valign=\"top\">{$item['mapel_nama']}<br><b>{$item['guru_nama']}<b></td>" . NL;
					...
					if( (($item['kategori_kode'] == 'KelA')||($item['kategori_kode'] == 'KelB')||
						...
						foreach($range10 as $range_kkm){
							$item['nas_teori'] = (int)$item['nas_teori'];
							if( ($range_kkm['max'] >= $item['nas_teori']) && ($range_kkm['min'] <= $item['nas_teori']) ){
								$item['pred_teori'] = $range_kkm['nilai'];
							}
							$item['nas_praktek'] = (int)$item['nas_praktek'];
							if( ($range_kkm['max'] >= $item['nas_praktek']) && ($range_kkm['min'] <= $item['nas_praktek']) ){
								$item['pred_praktek'] = $range_kkm['nilai'];
							}
						}
					}else{
...
function table_interval_kkm_sman14_v2()
{
	$html ='
	<table cellspacing="0" width="100%" >
	<tr>
...
function ttd_2013_sma14_v1($data,$type_ttd = 0)
{
	$nip=0;
	if(strpos(APP_SCOPE, 'sman') !== false)
	{
...
function ttd_2013_penerbad_v2($data,$row_per_siswa,$type_ttd = 0)
{
	$nip=0;
	if(strpos(APP_SCOPE, 'sman') !== false)
	{
	...
	$html .='       
		<tr>
			...
			<td colspan="3">
				...
				//$html .='		<br/><br/><br/><br/>';
				$html .='		<br/>';
				$html .='		<img style="margin:-15px" src="http://fresto.co/images/smk_penerbad/ttd_mukar.png" width="140"><br/>';
