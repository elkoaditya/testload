...
elseif (APP_SUBDOMAIN == 'sma_bang1n'):
	$db['default']['database'] = 'sma_bang1n';

elseif (APP_SUBDOMAIN == 'sma_muh1'):
	$db['default']['database'] = 'sma_muh1';
	
elseif (APP_SUBDOMAIN == 'smaissa1smg'):
	$db['default']['database'] = 'sma_issa1';
	
elseif (APP_SUBDOMAIN == 'sma_loyola'):
	$db['default']['database'] = 'sma_loyola';

elseif (APP_SUBDOMAIN == 'sma_terbang'):
	$db['default']['hostname'] = '10.76.132.148';
	$db['default']['database'] = 'sma_terbang';
	
elseif (APP_SUBDOMAIN == 'sma_setiabudhi'):
	$db['default']['database'] = 'sma_setiabudhi';
...
elseif (APP_SUBDOMAIN == 'smp_krismit'):
	$db['default']['database'] = 'smp_krismit';
	
elseif (APP_SUBDOMAIN == 'smp_yoannes'):
	$db['default']['database'] = 'smp_yoannes';

////// PPD
elseif (APP_SUBDOMAIN == 'ppd_smp_krismit'):
	$db['default']['database'] = 'ppd_smp_krismit';
	
////// testing 
elseif (APP_SUBDOMAIN == 'indonesia'):
