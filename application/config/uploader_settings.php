...
$config['img_path'] = APP_ADDRESS . 'content/' . strtolower(APP_SCOPE) . '/images'; // Relative to domain name
$config['upload_path'] = APP_ROOT . 'content/' . strtolower(APP_SCOPE) . '/images'; // Physical path. [Usually works fine like this]
