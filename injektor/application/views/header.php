...
elseif(APP_SUBDOMAIN == 'sma_bang1n')
{	$sekolah = 'SMAN 1 LIMBANGAN';		}	

elseif(APP_SUBDOMAIN == 'sma_muh1')
{	$sekolah = 'SMA MUHAMMADIYAH 1 SEMARANG';		}	
elseif(APP_SUBDOMAIN == 'smaissa1smg')
{	$sekolah = 'SMA ISLAM SULTAN AGUNG 1 SEMARANG';		}

elseif(APP_SUBDOMAIN == 'smapldonbosko')
{	$sekolah = 'SMA PL DON BOSKO SEMARANG';		}

elseif(APP_SUBDOMAIN == 'sma_loyola')
{	$sekolah = 'SMA LOYOLA SEMARANG';		}

elseif(APP_SUBDOMAIN == 'sma_terbang')
{	$sekolah = 'SMA TERBANG';		}

elseif(APP_SUBDOMAIN == 'sma_setiabudhi')
{	$sekolah = 'SMA SETIABUDHI SEMARANG';		}

// SMK
elseif(APP_SUBDOMAIN == 'smk_smg6n')
{	$sekolah = 'SMKN 6 SEMARANG';		}	
elseif(APP_SUBDOMAIN == 'smk_penerbangan')
{	$sekolah = 'SMK PKAB SEMARANG';		}	
elseif(APP_SUBDOMAIN == 'smk_pika')
{	$sekolah = 'SMK PIKA SEMARANG';		}	
elseif(APP_SUBDOMAIN == 'smk_terbang')
{	$sekolah = 'SMK TERBANG';		}	

//SMP
elseif(APP_SUBDOMAIN == 'smp_terbang')
{	$sekolah = 'SMP TERBANG';		}		
elseif(APP_SUBDOMAIN == 'smp_krismit')
{	$sekolah = 'SMP KRISTAMITRA';		}	
elseif(APP_SUBDOMAIN == 'smp_yoannes')
{	$sekolah = 'SMP YOANNES';		}  

// SD
elseif(APP_SUBDOMAIN == 'sd_terbang')
{	$sekolah = 'SD TERBANG';		}  
elseif(APP_SUBDOMAIN == 'sd_terbang2')
{	$sekolah = 'SD TERBANG 2';		}  

// PKBM
elseif(APP_SUBDOMAIN == 'pkbm_terbang')
{	$sekolah = 'PKBM TERBANG';		}  

//PPD
elseif(APP_SUBDOMAIN == 'ppd_sma_krismit')
{	$sekolah = 'PPD SMA KRISTAMITRA';		}		
elseif(APP_SUBDOMAIN == 'ppd_smk_penerbangan')
{	$sekolah = 'PPD SMK PKAB SEMARANG';		}	*/

$sekolah = strtoupper(str_replace("_"," ",APP_SUBDOMAIN));
?>
<!DOCTYPE html>
<html lang="en">
